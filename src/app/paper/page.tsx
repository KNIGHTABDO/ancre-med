...
ORDER BY score ASC LIMIT :limit;`}
          ...
          <section className="paper-section">
            ...
            <p>
              To resolve this, AncreMed implements a dual-path <strong>Agentic Router</strong> using <code>gemini-3.1-flash-lite</code>. 
          ...
          <section className="paper-section">
            ...
            <div className="reformulation-example">
              ...
              The prompt is analyzed by <code>gemini-3.1-flash-lite</code>. It classifies the intent as clinical (<code>is_conversational: false</code>) 
